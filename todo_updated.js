...
function display(){
    ...
    for(i=0;i<taskArray.length;i++){
        ...
        data+='<li class="list-inline-item"> <button class=" btn-floating btn-lg purple-gradient" type="button" onclick= "remove('+ i + ')"> <i class="fa fa-times" aria-hidden="true"></i></button> </li>';
        // data+='<li class="list-inline-item"> <button class=" list-group-item list-group-item-success " type="button" onclick= "markdone('+ i + ')"> <i class="fa fa-check" aria-hidden="true"></i></button> </li>';
        data+='<li class="list-inline-item"> <button class=" list-group-item list-group-item-info " type="button" onclick= "update('+ i + ')"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button> </li>';
        data+='</ul>'
    }
    list.innerHTML = data;
}
